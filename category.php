    ...
    <div class="cateogry-desc">
        <div class="cateogry-desc__container">
            <div class="text-show-more">
                ...
                $category_description = get_term_field('description', $category_id, 'category');
                ...
                if (strlen($text) > $maxLength) {
                    ...
                    echo '<div class="full-text" style="display:none;">' . $text . '</div>';
                    echo '
                    ...
                    echo '<div class="short-text">' . $text . '</div>';
                }
                ?>
            </div>
        </div>
