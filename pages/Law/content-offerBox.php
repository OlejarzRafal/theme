<section data-id="law-offerBox" class="law-offerBox">
    <div class="law-offerBox__container">
        <div class="law-items">
            <div class="law-items__item">
                <div class="law-items__desc">
                    <h3>Stała opieka prawna dla firm</h3>
                    <p>International law can refer to three things: public international law, private international law or conflict of laws and the law of </p>
                </div>
                <a href="" class="button-link law-items__btn">
                    Więcej informacji
                ...
                <div class="law-items__item__dashed"></div>
