<section data-id="home-team" class="home-team">
    <div class="home-team__container">
        <div class="home-team__top">
            ...
            <?php endif; ?>
            Jesteśmy zespołem którego szukasz
            Nasza wiedza i doświadczenie dają gwarancję profesjonalizmu naszych usług. Zapewniamy naszym Klientom optymalne rozwiązania dające prawne bezpieczeństwo i realne oszczędności.
        </div>
        <div class="home-team__main">
            <div class="home-team__items swiper-wrapper">
                <?php if (have_rows('home_person_carosuel')) : ?>
                    <?php $x = 1; // Zaczynamy od 1 
                    ?>
                    <?php while (have_rows('home_person_carosuel')) : the_row(); ?>
                        <div class="home-team__item-wrap swiper-slide">
