<section data-id="team-secTeam" class="team-secTeam team-secTeam-line">
                    ...
                    <?php while ( have_rows( 'team_main_list' ) ) :
                        ...
                        <div class="team-secTeam__item-wrap">
                            ...
                            <div class="team-secTeam__item-wrap__name-wrap">
                                ...
                                <?php endif; ?>
                                <?php if ( $team_main_list_info = get_sub_field( 'team_main_list_info' ) ) : ?>
                                    <div class="team-secTeam__item-wrap__name-wrap__text">
                                        <?php echo $team_main_list_info; ?>
                                    </div>
                                <?php endif; ?>
