<footer data-id="footer">
  <img src="<?php echo get_template_directory_uri(); ?>/assets/img/footer.svg" role="presentation" loading="lazy"
    decoding="async" alt="">

  <div class="footer__inner">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/footer-shape.png" role="presentation"
      loading="lazy" decoding="async" alt="" class="shape">
    <div class="footer__container">
      <div class="footer-top">
        <div class="footer-top__left">
          <h3 class="footer-top__subtitle">Potrzebujesz wsparcia prawnego?</h3>
          ...
          <a href="/kontalt" class="footer-top__contact">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
              <path fill-rule="evenodd" clip-rule="evenodd"
                d="M38.3333 20C38.3333 9.87478 30.1252 1.66667 20 1.66667C9.87478 1.66667 1.66667 9.87478 1.66667 20C1.66667 30.1252 9.87478 38.3333 20 38.3333C30.1252 38.3333 38.3333 30.1252 38.3333 20ZM40 20C40 8.95431 31.0457 0 20 0C8.9543 0 0 8.95431 0 20C0 31.0457 8.9543 40 20 40C31.0457 40 40 31.0457 40 20ZM15.6407 25.7024L24.7064 16.6366L24.7064 26.6026L26.3731 26.6026V13.7914H13.5619V15.4581H23.528L14.4622 24.5239L15.6407 25.7024Z"
                fill="#141B47" />
            </svg>
          </a>
        </div>
      ...
      <div class="footer-main">
        ...
        ?>
          <a href="/" class="footer-main__media">Grafiki i koncepcja strony</a>
        </div>
