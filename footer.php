        ...
        <div class="footer__container">
            ...
            <div class="footer-main">
                <div class="footer-main__left">
                    ...
                    ?>
                    <?php
                    $link = get_field('footer_link_extra_menu_o', 'options');
                    if ($link) :
                        $link_url = $link['url'];
                        $link_title = $link['title'];
                        $link_target = $link['target'] ? $link['target'] : '_self';
                    ?>
                        <a class="footer-main__media" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?></a>
                    <?php endif; ?>
                </div>
