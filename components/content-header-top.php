<div class="header__top">
    ...
    <div class="header__contact">
        ...
        <div class="header-item phone">
            <a href="tel:<?= get_field('h-phone-1', 'options'); ?>" class="bold"><?php the_field('h-phone-1', 'options'); ?></a>
            <a href="tel:<?= get_field('h-phone-2', 'options'); ?>" class="bold"><?php the_field('h-phone-2', 'options'); ?></a>
        </div>
        <div class="header-item email">
            <a href="mailto:<?= get_field('h-email', 'options'); ?>" class="bold"><?php the_field('h-email', 'options'); ?></a>
            <p class="regular"><?php the_field('h-email-text', 'options'); ?></p>
        </div>
        <div class="header-item social">
            <a href="<?= get_field('linkedin', 'options'); ?>" target="_blank" rel="nofollow noopener">
        ...
        <div class="header-item social">
            <a href="<?= get_field('facebook', 'options'); ?>" target="_blank" rel="nofollow noopener">
