<section data-id="contents-brands" class="contents-brands">
        <div class="contents-brands__container">
                ...
                <div class="contents-brands__right">
                        <?php if ( have_rows( 'brand_lista' ) ) : ?>
                                <?php while ( have_rows( 'brand_lista' ) ) :
                                        the_row(); ?>
                                        <div class="contents-brands__right__item">
                                                <?php
                                                $brand_lista_logo = get_sub_field( 'brand_lista_logo' );
                                                if ( $brand_lista_logo ) : ?>
                                                        <img src="<?php echo esc_url( $brand_lista_logo['url'] ); ?>" alt="<?php echo esc_attr( $brand_lista_logo['alt'] ); ?>" />
                                                <?php endif; ?>
                                        </div>
                                <?php endwhile; ?>
                        <?php endif; ?>
